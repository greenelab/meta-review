...
This version of the manuscript [contains changes](https://github.com/greenelab/meta-review/compare/b90923a99208c9152cec7929399ab1b7929cb7e2...{%- if ci_source is defined -%}{{ci_source.commit}}{%- else -%}master{%- endif -%}) subsequent to the journal publication.
