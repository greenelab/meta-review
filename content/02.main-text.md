...
Pressure from funders, libraries, self-archiving, and piracy are set to cement open access as the primary model for publishing the scientific record [@doi:10.7717/peerj.4375; @doi:10.7554/eLife.16800; @doi:10.7554/eLife.32822; @doi:10.1038/d41586-018-05754-1].
...
For open science to accelerate the pace of discovery and encourage maximal contribution to the public scientific record, researchers will require a comprehensive suite of tools that replace closed & proprietary services with open and community-driven services.
...
Manuscripts are a cornerstone of scholarly communication, but drafting and publishing manuscripts has traditionally relied on proprietary or offline tools that do not support _open scholarly writing_, where anyone is able to contribute and the contribution history is preserved and public.
Hence, we report a new tool to author scholarly manuscripts in the open, as well as the collaborative project which led to its creation.
