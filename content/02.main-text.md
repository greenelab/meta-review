...
Papers with hundreds or thousands of authors ("hyperauthorship") are on the rise, such as the article describing the experiments and data that led to thd discovery of the Higgs Boson [@doi:https://doi.org/10.1103/PhysRevLett.114.191803] (5000 authors) and the article reporting the Drosophila genome [@doi:https://doi.org/10.1534/g3.114.015966] (1000 authors).
Yet  in _the number of people that participated in writing_ those papers, as opposed to generating and analyzing the data, is not always clear and likely to be far below the number of authors [@doi:10.1038/521263f; @doi:10.1038/nature.2015.17567].  
