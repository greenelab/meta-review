...
The plugins add special interactive features that enhance the user experience of viewing and reading manuscripts (Figure @fig:plugins).
...
The architecture of these plugins and themes is designed to provide the author with enough flexibility to suit their particular needs and preferences.
...
The plugins utilize standard technology built in to (almost) all major web browsers, allowing them to be relatively lightweight, modular, and easy to configure.
