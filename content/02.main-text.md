...
Papers with hundreds or thousands of authors ("hyperauthorship") are on the rise, such as the article announcing the discovery of the Higgs Boson [@doi:https://doi.org/10.1103/PhysRevLett.114.191803] (5000 authors) and the article reporting the Drosophila genome [@doi:https://doi.org/10.1534/g3.114.015966] (1000 authors).
Yet  in _the number of people that participatedwriting_ those papers, as opposed to generating and analyzing the data, is not always clear and likely to be far below the number of authors [@url:https://www.nature.com/news/fruit-fly-paper-has-1-000-authors-1.17555; @url:https://www.nature.com/news/physics-paper-sets-record-with-more-than-5-000-authors-1.17567].  
