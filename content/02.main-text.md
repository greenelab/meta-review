...
| Character-level provenance for text | Yes | No (versions tracked by day) | No (simultaneous edits online can be attributed to a single author) | Requires manual inspection of history | Not after changes are accepted | Yes |
...
| Open pricing | Free | Free | Free | Costs for PaperPile and Google Drive Storage | Online access is free, desktop applications require paid subscriptions or software | Free |
| Private pricing | GitHub and TravisCI costs | One document free, more paid | Free: limited storage space, specific limitations on versioning; Paid: more functionality | Costs for PaperPile and Google Drive storage | Online access is free, desktop applications require paid subscriptions or software | GitHub costs |
...
Because our writing process tracks the complete commit history through git commits, it enables detailed retrospective contribution analysis.
