...
To address these challenges, we developed a manuscript writing process using the Markdown language, the GitHub platform, and our new [Manubot tool](https://github.com/greenelab/manubot) for automating manuscript generation.
...
The approach uses continuous integration (CI) [@doi:10.1038/550143a; @doi:10.1038/nbt.3780; @doi:10.1101/344804], specifically [Travis CI](https://travis-ci.org/) at the moment, to monitor changes.
