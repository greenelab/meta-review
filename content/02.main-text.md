...
In January 2018, the article was accepted by the journal that it was initially submitted to.
We'll discuss our experience with the Deep Review project including the pros and cons of open collaborative reviews, as well as the infrastructure we created, termed Manubot, to enable open manuscript writing online.
We also discuss the extent to which such efforts can contribute to a living and frequently updated literature. `todo: discuss stage 2 maintainers?`
...
The entire process can be orchestrated through GitHub with a web browser.
