...
In addition, we introduce the infrastructure we created for Deep Review, termed [Manubot](https://github.com/greenelab/manubot-rootstock), that enables open manuscript writing online.
