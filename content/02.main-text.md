...
Use of CI to build the manuscript automatically catches to catch common errors such as misspelled citations, invalid formatting, or misconfigured software dependencies.
