...
In this example, where manuscript text is shown in solid lines on the left of the timline and discussion on github is shown by squiggly lines to the right of the timeline, the contributor opens an issue to discuss a manuscript modification.
