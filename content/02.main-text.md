...
Additionally, discussing manuscripts in the open generates valuable post-publication peer review (and potentially pre-publication peer review in the case of preprints [@doi:10.7554/eLife.38532]).
Since incentives are commonly lacking to provide public peer review of existing literature, open collaborative reviews --- where authorship is open to anyone who makes a valid contribution --- could help spur more post-publication peer review.
