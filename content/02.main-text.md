...
Openness in research benefits the researchers who practice it [@doi:10.7554/eLife.16800], their scientific peers, and the public.
Improving the availability of code and data helps ensure the methods are transparent and the results can be reproduced  [@doi:10.1038/s41562-016-0021].
Publishing in an open access journal increases the number of readers and reviewers [@doi:10.1371/journal.pone.0000308].
...
| Tool | Manubot | Authorea + BibTeX | Overleaf + BibTeX | Google Docs + Paperpile | Word Online<sup>1</sup> | Markdown on GitHub |
|--------------------------------------------|---------------------------|----------------------------------------------------|----------------------------------------------------------------------------------------------------|---------------------------------------------------|------------------------------------------------------------------------------------|--------------------|
| Multi-author editing | Yes | Yes | Yes | Yes | Yes | Yes |
| Propose changes | Yes | No | No | Yes | No | Yes |
| Automatic change testing | Yes | No | No | No | No | No |
| Multi-participant conversation for changes | Yes | No - conversation occurs on document, not changes. | No - conversation occurs on document, not changes. | No - conversation occurs on document, not changes | No - conversation occurs on document, not changes | Yes |
| Character-level provenance for text | Yes | No (versions tracked by day) | No (simultaneous edits online can be attributed to a single author) | Yes, manual inspection of history | Not after changes are accepted | Yes |
...
| Open Pricing | Free | Free | Free | Costs for PaperPile & Google Drive Storage | Online access is free, desktop applications require paid subscriptions or software | Free |
| Private Pricing | GitHub and TravisCI Costs | 1 document free, more paid | Free: limited storage space, specific limitations on versioning / Paid provides more functionality | Costs for PaperPile & Google Drive Storage | Online access is free, desktop applications require paid subscriptions or software | GitHub |

Table: Collaborative writing platforms.
A summary of popular collaborative writing platforms.
Features were assessed on June 15, 2018.
