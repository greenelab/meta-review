...
These platforms typically offer version control, multiple permission levels, and other functionality to support multi-author document editing.
...
An official master version is _forked_ by individual contributors.
...
Once all requested modifications are made, the manuscript maintainers, a subset of authors with elevated GitHub permissions, formally approve the pull request and merge the changes into the official master version.
