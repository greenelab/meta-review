...
](https://github.com/dhimmel/meta-review/raw/0b384feb34f9568f8abc6b814b25730d2aaea51f/analyses/deep-review-contrib/deep-review-contribution-ridge.png){#fig:contrib width="100%"}
...
After releasing the first version of our collaborative review [@doi:10.1101/142760], six new authors have contributed text (Figure @fig:contrib) and existing authors continue to discuss new literature, [creating a living document](https://github.com/greenelab/deep-review/).
