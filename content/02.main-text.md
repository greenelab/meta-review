...
The way science is performed is undergoing a terrific transition towards openness.
The rise of the internet has enabled a global information commons, where scholarship can be publicly shared at a minimal cost.
First, open access publishing provided an economic model that encourages maximal dissemination and reuse of scholarly articles [@doi:10.12688/f1000research.8460.3].
Pressure from funders, libraries, self-archiving, and piracy are set to cement open access as the primary model for publishing the scientific record [@doi:10.7287/peerj.preprints.3119v1, @doi:10.7554/eLife.16800; @doi:10.7554/eLife.32822; @doi:10.1038/d41586-018-05754-1].
However, open science extends beyond just open access to journal articles.
Open licensing solves legal barriers to content reuse, enabling any type of scholarly output to become part of the commons [@doi:10.1109/MCSE.2009.19; @doi:10.1038/536016a].
...
The push for increased reproducibility and the opportunity to reuse data and code for new investigations has begot a movement to make all research outputs public, unless there are bonafide privacy or security concerns [@doi:10.1126/science.aah6168; @doi:10.1038/nature10836; @doi:10.1371/journal.pbio.1001195].
Meanwhile, open source software has enabled computational infrastructure to reach new heights, in terms of quantity, quality, and recruitment of contributions.
...
At the extreme is real-time open science, whereby studies are performed entirely in the open from their inception.
Many such research projects have now been completed, benefiting from the associated early-stage peer review, additional opportunity for online collaboration, and increased visibility [@doi:10.1242/dmm.003285; @doi:10.3897/rio.1.e7547; @doi:10.7554/eLife.26726].

In short, science is experiencing a sort of Cambrian explosion, whereby opening the process of the scholarship is accelerating the pace of discovery.
However, for this vision to reach its full potential, researchers will require a comprehensive suite of tools that replace closed & proprietary services (which tend to minimize the extent of contributions to a public scientific record) with open & community-driven services (which encourage maximal contribution to the public scientific record).
Hence, we report a new tool to author scholarly manuscripts in the open, as well as the collaborative project which led to its creation.
