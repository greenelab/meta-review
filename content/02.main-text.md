...
Use of CI to build the manuscript allows users to catch common errors (e.g. tag typos, non-existent tags, or JSON format errors) as well as detect broken or missing citations.
