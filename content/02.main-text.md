...
Sometimes however, external resources provide Manubot with invalid CSL Data, which can crash downstream citation processors, such as [pandoc-citeproc](http://hackage.haskell.org/package/pandoc-citeproc).
...
This utility produces CSL Data Items (i.e. JSON-formatted reference metadata) for a list of citations.
For example, `manubot cite doi:10.1098/rsif.2017.0387`, returns the CSL Data for the Deep Review.
