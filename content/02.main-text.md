...
There are many existing collaborative writing platforms ranging from rich text editors, which support Microsoft Word documents or similar formats and provide "what you see is what you get" (WYSIWYG) interfaces, to LaTeX-based systems for technical writing [@doi:10.1038/514127a] such as [Overleaf](https://www.overleaf.com/) and [Authorea](https://www.authorea.com/).
...
| WYSIWYG mode | No | Rich text available | Rich text available | ? | ? | Preview rendered Markdown |
| Inline comments | Yes using Hypothesis | Yes | Yes | ? | ? | No |
| Viewing changes | Diff of manuscript source | History view highlights changes | Compare labeled versions | ? | ? | Diff of manuscript source |
