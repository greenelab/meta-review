...
TODO: content directory with markdown, metadata, image files.
...
Contributing to an existing manuscript is less technical and can be performed entirely through GitHub's web interface.
Video S1 demonstrates this process.
Interested readers can practice editing an existing demo manuscript at <https://github.com/manubot/try-manubot>.

TODO: At the 2019 _Pacific Symposium on Biocomputing_, we led a working group where 17 conference participants contributed to a [demo manuscript](https://git.dhimmel.com/psb-manuscript/). SHOULD THIS GO IN CONTRIBUTION WORKFLOW.
