...
Papers with hundreds or thousands of authors are on the rise, such as the article describing the experiments and data that led to thd discovery of the Higgs Boson [@doi:10.1103/PhysRevLett.114.191803] (5000 authors) and the report of the Drosophila genome [@doi:10.1534/g3.114.015966] (1000 authors).
