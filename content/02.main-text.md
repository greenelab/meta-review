...
When changes occur, the CI service rebuilds the manuscript.
If the manuscript build process is error free, the CI service timestamps the manuscript and uploads the output files to the GitHub repository.
