...
In May 2017, the project, code-named the Deep Review, released a complete review as a preprint titled "Opportunities and obstacles for deep learning in biology and medicine" [@doi:10.1101/142760].
While the article was under review, we continued to maintain the project and accepted new contributions.
In February 2018, the article was accepted by the journal that it was initially submitted to and subsequently published in April [@doi:10.1098/rsif.2017.0387].
...
Additionally, discussing manuscripts in the open generates valuable post-publication peer review [@doi:10.1016/j.tig.2015.03.006; @doi:10.1371/journal.pmed.1001772; @doi:10.3389/fncom.2012.00063] (and potentially pre-publication peer review in the case of preprints [@doi:10.7554/eLife.38532]).
Since incentives are commonly lacking to provide public peer review of existing literature [@doi:10.1629/uksg.245], open collaborative reviews --- where authorship is open to anyone who makes a valid contribution --- could help spur more post-publication peer review.
