...
Manubot supports citations by adding a standard identifier like a Digital Object Identifier (DOI) or PubMed Identifier (PMID) directly in the text so that large groups of authors do not have to coordinate reference lists.
...
Because Manubot manuscripts are created from GitHub repositories, all edits are reviewed and discussed, ensuring that the collaborative text has a cohesive style and message and that authors receive precise credit for their work.
...
Others are LaTeX-based systems for technical writing [@doi:10.1038/514127a], such as [Overleaf](https://www.overleaf.com/) and [Authorea](https://www.authorea.com/).
...
| --- | --- | --- | --- |
| DOI | DOI [Content Negotiation](https://citation.crosscite.org/docs.html) | `doi:10.1098/rsif.2017.0387` | [@doi:10.1098/rsif.2017.0387] |
| shortDOI | DOI Proxy Server REST API | `doi:10/gddkhn` | [@doi:10/gddkhn] |
| PMID | NCBI [E-utilities](https://www.ncbi.nlm.nih.gov/books/NBK25501/) | `pmid:25851694` | [@pmid:25851694] |
