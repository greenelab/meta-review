...
[Dokieli](https://dokie.li/) stores articles as HTML and includes a clientside editor to allow reader annotation and interaction [@doi:10.1007/978-3-319-60131-1_33].
[Texture](https://substance.io/texture/) is a browser-based editor for scholarly manuscripts stored as JATS.

Several projects in addition to Manubot provide infrastructure for citation by identifier. For example, the [knitcitations](https://github.com/cboettig/knitcitations) package enables citation by DOI or URL in R Markdown documents.
