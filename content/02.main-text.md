...
Manual CSL JSON allows supports references without standard identifiers, such as newspaper articles.
...
| PubMed Central Identifier (PMCID) | NCBI's [Literature Citation Exporter](https://api.ncbi.nlm.nih.gov/lit/ctxp/) | `pmcid:PMC4719068` | [@pmcid:PMC4719068] |
